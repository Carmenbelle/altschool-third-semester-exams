...
<template>
      ...
      <div class="grid p-8 md:p-16 md:grid-cols-3 space-x-8 md:space-x-10 gap-10">
        ...
        <ul class="border p-10 border-white drop-shadow-xl bg-slate-100" v-for="item in gadget" :key="item.id">
         <!-- <li>{{ item.id }}</li> -->
         <div class=" w-[full] h-[300px] ">
           <li class="w-full  "> <img :src="item.images[0]" class="h-[200px] w-full" /> </li>
           <div class="pt-6">

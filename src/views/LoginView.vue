...
<template>
  <div class="container w-full h-[100vh] relative">
    ...
    <div class="w-full h-full absolute inset-0 bg-[#374efa] bg-opacity-80">
      ...
      <div
        class="text-[#1a2934] backdrop-opacity-10 border max-w-md py-4 mx-auto bg-white bg-opacity-20 shadow-lg shadow-black-500/50 px-4 md:px-6"
      >
        <div class="text-xl">
          ...
          <form @submit.prevent="login">
            ...
            <div class="space-y-1">
              ...
              <input
                ...
                id="email"
                v-model="email"
                class="w-full rounded-lg py-3 px-4 bg-transparent border-2 border-solid border-black"
              />
            ...
            <div class="text-center py-4">
              <button type="submit" class="hover:text-[#30658b] font-semibold">
                Login
              </button>
            </div>
          </form>
          <div class="text-center text-base text-[#162c3e] py-4">
            <p>
              ...
              <router-link to="/signup" class="hover:text-[#13a69a]"
                >Sign Up</router-link
              >
            </p>
          </div>
